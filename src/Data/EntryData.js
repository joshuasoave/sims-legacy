export const entryData = [
  {
    ...
    photos: [
      {
        photo: "https://i.imgur.com/YRhqCPn.png",
        caption: "Layout of the house and creative circle",
      },
      {
    ...
    story: (
      <div>
        <p>
          And so it all began, a fateful day in The House of Fame! Six hopefuls
          were handpicked to embark on a quest for global stardom. Nestled in
          Del Sol Valley, on a sprawling 64x64 lot, lies our stage for glory.
          But wait, there's more! Behold the creative circle, where each sim
        ...
        <p>
          ...
          unfolds in the creative circle, where friendships blossom and drama
          brews. Keep an eye on Eloise and Sage, who are growing closer by the
          day, despite both being married. Talk about a twist!
        </p>
        ...
        <p>
          ...
          thrilling invitation to share the stage. With this unexpected turn,
